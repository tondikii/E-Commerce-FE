      ...
      <div className="flex flex-col w-full md:w-1/4 px-4 py-2 space-y-1 md:space-y-2 lg:space-y-4">
        <div className="flex flex-row w-full justify-between">
          ...
          <a href={"https://api.whatsapp.com/send?phone=6285920685311&text=Hubungi%20admin"} className="flex flex-row space-x-2 md:absolute md:left-3/4">
            <PhoneIcon className="text-white h-6 w-6 text-md md:font-xl lg:text-2xl font-medium md:font-semibold lg:w-8 lg:h-8" />
            <p className="text-white text-md md:font-xl lg:text-2xl font-medium  md:font-semibold">
              085920685311
            </p>
          </a>
        </div>
        <div className="flex flex-row w-full justify-between">
          ...
          <div className="flex flex-row space-x-2 md:absolute md:left-3/4 ">
            <OfficeBuildingIcon className="text-white h-6 w-6 text-md font-medium lg:text-2xl lg:w-8 lg:h-8" />
            <p className="text-white text-md font-medium lg:text-2xl">
              {" "}
