        ...
        <div className="w-96">
            ...
            {errors.fullName.length > 0 &&
              errors.fullName.map((err) => (
                <div className="flex flex-row items-center space-x-1 w-screen my-1">
                  <ExclamationCircleIcon class="h-5 w-5 text-red-600 font-bold" />
          ...
          <div>
            ...
            {errors.email === 1 &&
                ...
                <div className="flex flex-row items-center space-x-1 w-screen my-1">
                  <ExclamationCircleIcon class="h-5 w-5 text-red-600 font-bold" />
                  <p className="text-sm text-red-600 font-medium">Email already exist</p>
                </div>
              }
          </div>
          <div>
          ...
          <div>
            ...
            {errors.phoneNumber === 1 &&
                ...
                <div className="flex flex-row items-center space-x-1 w-screen my-1">
                  <ExclamationCircleIcon class="h-5 w-5 text-red-600 font-bold" />
                  <p className="text-sm text-red-600 font-medium">Phone Number cannot be empty</p>
                </div>
              }
          </div>
        </div>
